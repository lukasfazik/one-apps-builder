class ImageNames:
    def __init__(self, prefix: str="", architecture: str="", language: str="", suffix: str="") -> None:
        self._names = {
            ...
            # Windows 11
            "windows11Home": f"{prefix}Windows 11 Home 24H2 {architecture} {language}{suffix}",
            "windows11HomeN": f"{prefix}Windows 11 Home N 24H2 {architecture} {language}{suffix}",
            "windows11HomeSingleLanguage": f"{prefix}Windows 11 Home Single Language 24H2 {architecture} {language}{suffix}",
            "windows11Pro": f"{prefix}Windows 11 Pro 24H2 {architecture} {language}{suffix}",
            "windows11ProN": f"{prefix}Windows 11 Pro N 24H2 {architecture} {language}{suffix}",
            "windows11ProWorkstations": f"{prefix}Windows 11 Pro for Workstations 24H2 {architecture} {language}{suffix}",
            "windows11ProWorkstationsN": f"{prefix}Windows 11 Pro for Workstations N 24H2 {architecture} {language}{suffix}",
            "windows11ProEducation": f"{prefix}Windows 11 Pro Education 24H2 {architecture} {language}{suffix}",
            "windows11ProEducationN": f"{prefix}Windows 11 Pro Education N 24H2 {architecture} {language}{suffix}",
            "windows11Education": f"{prefix}Windows 11 Education 24H2 {architecture} {language}{suffix}",
            "windows11EducationN": f"{prefix}Windows 11 Education N 24H2 {architecture} {language}{suffix}",
            "windows11Enterprise": f"{prefix}Windows 11 Enterprise 24H2 {architecture} {language}{suffix}",
            "windows11EnterpriseN": f"{prefix}Windows 11 Enterprise N 24H2 {architecture} {language}{suffix}",
